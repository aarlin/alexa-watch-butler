...
def get_token_through_phone(confirmation_code, phone_number, request_code):
    ...
    VALIDATE_URL = CODE_VALIDATE_URL.replace("#confirmation_code", confirmation_code)
...
def phone_authentication(phone_number, confirmation_code):
    request_code = send_phone_code(phone_number)
    auth_token = get_token_through_phone(confirmation_code, phone_number, request_code)
    return auth_token